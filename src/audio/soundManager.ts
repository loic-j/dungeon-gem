...
const MELODY: Note[] = [
  ...
  { f: 220,    d: 0.4 }, { f: 261.63, d: 0.4 }, { f: 329.63, d: 0.4 }, { f: 293.66, d: 0.8 },
  { f: 261.63, d: 0.4 }, { f: 246.94, d: 0.4 }, { f: 220,    d: 0.8 },
  // Phrase B — descending
  { f: 329.63, d: 0.4 }, { f: 293.66, d: 0.4 }, { f: 261.63, d: 0.4 }, { f: 246.94, d: 0.8 },
  { f: 220,    d: 0.4 }, { f: 196,    d: 0.4 }, { f: 220,    d: 0.8 },
  // Phrase C — tension climb
  { f: 392,    d: 0.4 }, { f: 369.99, d: 0.4 }, { f: 329.63, d: 0.4 }, { f: 293.66, d: 0.4 },
  { f: 261.63, d: 0.4 }, { f: 246.94, d: 0.4 }, { f: 220,    d: 0.4 }, { f: 196,    d: 0.4 },
  { f: 220,    d: 1.2 },
  // Phrase D — low figure
  { f: 164.81, d: 0.4 }, { f: 174.61, d: 0.4 }, { f: 196,    d: 0.4 }, { f: 220,    d: 0.8 },
  { f: 246.94, d: 0.4 }, { f: 261.63, d: 0.4 }, { f: 220,    d: 0.8 },
  { f: 196,    d: 0.4 }, { f: 174.61, d: 0.4 }, { f: 164.81, d: 1.2 },
]

const BASS: Note[] = [
  { f: 110,    d: 1.6 }, { f: 164.81, d: 1.6 }, { f: 130.81, d: 1.6 }, { f: 146.83, d: 1.6 },
  { f: 110,    d: 3.2 }, { f: 130.81, d: 1.6 }, { f: 164.81, d: 1.6 },
]
...
function scheduleVoice(notes: Note[], startTime: number, gainValue: number, type: OscillatorType = 'triangle'): void {
  const c = getCtx()
  let t = startTime
...
export function startBackgroundMusic(): void {
  ...
  function melodyLoop() {
    ...
    melodyScheduler = setTimeout(melodyLoop, Math.max(0, (nextMelody - c.currentTime - 0.5) * 1000))
  }

  function bassLoop() {
    scheduleVoice(BASS, nextBass, 0.08, 'sine')
    nextBass += BASS_LOOP_DUR
    bassScheduler = setTimeout(bassLoop, Math.max(0, (nextBass - c.currentTime - 0.5) * 1000))
  }
...
export function stopBackgroundMusic(): void {
  ...
  bgDrones.forEach(n => { try { n.stop() } catch { /* already stopped */ } })
  bgGain?.disconnect()
  bgGain = null
  bgDrones = []
